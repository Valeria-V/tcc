    ...
    try {
      ...
      .then(data => {
        ...
        $('#send_message').on('click', function() {
          ...
          const postUpdateUrl = `https://tcc-production.up.railway.app/api/starvingless/user/v1/update/${data.Id}`;
          fetch(postUpdateUrl, {
            method: "PUT",
            headers: headers,
        ...
        $(excluirUser).on('click', function() {
          ...
          if (confirm(textExcluir) == true) {
              ...
              const postDeleteUrl = `https://tcc-production.up.railway.app/api/starvingless/user/v1/delete/${data.Id}`;
              fetch(postDeleteUrl, {
                method: "DELETE",
                headers: headers,
              })
