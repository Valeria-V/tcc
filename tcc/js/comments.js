      ...
      .then(data => {
        ...
        $(excluirPost).on('click', function() {
          ...
          if (confirm(textExcluir) == true) {
              ...
              const postDeleteUrl = `https://tcc-production.up.railway.app/api/starvingless/comment/v1/cm/delete/${postId}`;
              fetch(postDeleteUrl, {
                method: "DELETE",
                headers: headers,
              })
        ...
        $('.send_message').on('click', function() {
          ...
          const postUpdateUrl = `https://tcc-production.up.railway.app/api/starvingless/comment/v1/cm/update/${envioId}`;
          fetch(postUpdateUrl, {
            method: "PUT",
            headers: headers,
