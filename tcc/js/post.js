      ...
      .then(data => {
        ...
        $(excluirPost).on('click', function() {
          ...
          if (confirm(textExcluir) == true) {
              ...
              const postDeleteUrl = `https://tcc-production.up.railway.app/api/starvingless/post/v1/pt/delete/${postId}`;
              fetch(postDeleteUrl, {
                method: "DELETE",
                headers: headers,
              })
        ...
        $('#send_message').on('click', function() {
          ...
          const postId = document.getElementById("postselecionado").getAttribute('data-user-post');
          const postUpdateUrl = `https://tcc-production.up.railway.app/api/starvingless/post/v1/pt/update/${postId}`;
          fetch(postUpdateUrl, {
            method: "PUT",
            headers: headers,
        ...
        fetch(`https://tcc-production.up.railway.app/api/starvingless/comment/v1/cm/post/${commentId}?size=${listSize}`, requestOptions)
        .then(response => response.json())
        .then(comments => {
          ...
          userElements.forEach(userElement => {
            userElement.addEventListener('click', () => {
              ...
              const postDetailsUrl = `https://tcc-production.up.railway.app/api/starvingless/comment/v1/cm/id/${postId}`;
        ...
        $('#send_comment').on('click', function() {
          ...
          const postEnvioUrl = `https://tcc-production.up.railway.app/api/starvingless/comment/v1/cm/create`;
          fetch(postEnvioUrl, {
            method: "POST",
            headers: headers,
            body: JSON.stringify(envioPost)
